...
home_town = {'city': 'Surat', 'state': 'Gujarat', 'population': '7 million'}

def hometown_info():
    # your code here
    return f"I was born in {home_town.get('city')}, {home_town.get('state')} - population of {home_town.get('population')}"
